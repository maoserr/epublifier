...
<!--                                @status="status_txt=$event"></ParserEditor>-->
        ...
        <div class="p-fluid p-formgrid p-grid">
            ...
            <div class="p-field p-col-3">
                <Button icon="pi pi-times" class="p-button-danger" label="Delete Selected" @click="deleteSel()"
                    ...
                    <Column :exportable="false" style="min-width:8rem" header="Edit Content">
                        <template #body="slotProps">
                            <Button icon="pi pi-pencil" class="p-button-rounded p-button-success p-button-sm"
                                    @click="edit_chap(slotProps.data)" :disabled='!!slotProps.data.html_parsed'/>
                        </template>
                    </Column>
                </DataTable>
            </div>
...
import {load_parsers, save_parsers} from "../../common/parser_manager";
...
export default defineComponent({
    ...
    data() {
        return {
            ...
            chapts: null as unknown as Chapter[],
            parsers: null,
            selectedParser: '',
            parser_txt: "",
            diag_show: false,
    ...
    computed: {
        btn_disabled(): boolean {
            return this.selected_chaps.length == 0;
        },
        btn_comp_disabled(): boolean {
    ...
    methods: {
        ...
        onRowReorder(event: { value: { url: string; url_title: string; parser: string; title: string; html: string; html_parsed: string; }[]; }) {
